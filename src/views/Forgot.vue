  ...
  <div class="login">
    ...
    >
      <template #left>
        <div class="nav-left">
          <div class="logo">
            <img class="auto_img" src="../assets/images/logo.jpg" alt="">
          </div>
          <div class="logo-text">Sakuragi Coffee</div>
        </div>
      </template>
    </van-nav-bar>
    ...
    <div class="user-box">
      ...
      <van-form v-show="!isNext">
        ...
        >
           <template #button>
            <van-button size="small" color="#00adb5" :disabled="isSend" @click="getValidCode">{{text}}</van-button>
          </template>
        </van-field>
        <div class="forgot">
        ...
        <div class="commit-btn">
          <van-button @click="next" round block color="#00adb5">
            下一步
          </van-button>
        </div>
      </van-form>
      ...
      <van-form v-show="isNext">
        ...
        <div class="commit-btn">
          <van-button round block color="#00adb5" @click="commit">
            提交
          </van-button>
        </div>
        <div class="commit-btn">
